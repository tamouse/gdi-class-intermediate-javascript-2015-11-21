...
$( document ).ready(function() {
    ...
    $("form").on("submit", function(e) {
        ...
        // Last, but not least, we're doing this weird little thing to fire off the email.

        // You'll need to get the "action" attribute from the form. That contains our "MAILTO" string.
        // Set it to the actionAttribute variable declared here.

        // Hint: You'll need to use $(this)
        // Need help? Try: http://api.jquery.com/attr/
        // You'll change this line into: var actionAttribute = [your fancy code here];
        var actionAttribute;

        window.location = actionAttribute + "?body=" + emailBody + "&subject=Form Submission";
    });
